...
if "session_logged" not in st.session_state:
    ...
    try:
        ...
        pass
    # Don't log the sidebar default as a user action — only log data_source
    # when the user actually uploads or connects (those events have their own log_event calls)
    log_event("session_start", referrer=_referrer)
